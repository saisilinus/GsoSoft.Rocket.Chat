...
import { IGatewayCreateParams } from '../../sdk/types/IGatewayService';
...
Meteor.methods({
	...
	async 'createManyGateways'(gateways: IGatewayCreateParams[]): Promise<void> {
		const Gateways = new GatewayService();
		await Gateways.createMany(gateways);
	},
